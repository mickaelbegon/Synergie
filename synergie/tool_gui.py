...
class SynergieToolsApp:
    ...
    def _build_annotate_tab(self, parent: ttk.Frame) -> None:
        ...
        controls = ttk.LabelFrame(left_panel, text="Annotation", padding=8)
        controls.grid(row=2, column=0, sticky="nsew", pady=(12, 0))
        ...
        self.annotation_jump_listbox = tk.Listbox(center_panel, exportselection=False, height=8)
        ...
        bottom_panel.columnconfigure(1, weight=2)
